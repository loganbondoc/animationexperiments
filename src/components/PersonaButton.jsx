...
export default function PersonaButton() {
  ...
  useEffect(() => {
    ...
    // Run animation only when mouse enters #outline1
    outline1.addEventListener("mouseenter", () => {
  ...
  return (
    <div>
      ...
      <svg id="outline2" width="859" height="183" viewBox="0 0 859 183" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }}>
        <path d="M858.266 27L38.2656 0L0.000488281 182.848L734.266 164.5L858.266 27Z" fill="#FF0107" />
      </svg>
